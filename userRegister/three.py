...
class Register(unittest.TestCase):
    ...
    browser.find_element_by_id( "loginName" ).send_keys('xianyang001')
    time.sleep(2)
    ...
    browser.find_element_by_id( "hospitalName" ).send_keys(u"咸阳三级综合非营利zkx" )
    time.sleep(2)
    ...
    browser.find_element_by_id( "orgLicenseNo" ).send_keys('12342222452' )
    time.sleep(2)
    ...
    browser.find_element_by_id( "organizationCode" ).send_keys('1212123111116345435' )
    time.sleep(2)
    ...
    browser.find_element_by_id( "businessLicenseNo" ).send_keys('12121236333444511435' )
    time.sleep(2)
