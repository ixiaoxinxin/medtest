...
class Register(unittest.TestCase):
    ...
    browser.find_element_by_id( "orgLicenseNo" ).send_keys('123452' )
    time.sleep(2)
    ...
    browser.find_element_by_id( "organizationCode" ).send_keys('121212313435' )
    time.sleep(2)
    ...
    browser.find_element_by_id( "businessLicenseNo" ).send_keys('12123635135' )
    time.sleep(2)
